...
class Page extends SiteTree {
	...
	private static $has_one = array(
        ...
        public function getCMSFields() {
            ...
            $fields->addFieldToTab('Root.HTML', new TextAreaField("HTMLHeaderSnippet", "HTML header code"));    
            $fields->addFieldToTab('Root.HTML', new TextAreaField("HTMLBodySnippet", "HTML body code"));    
